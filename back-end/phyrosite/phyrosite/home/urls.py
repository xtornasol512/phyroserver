...
urlpatterns=patterns('phyrosite.home.views',
    ...
    url(r'^team/jesus/$', 'redi_jesus'),
    url(r'^team/chuko/$', 'redi_jesus'),
    url(r'^team/chucho/$', 'redi_jesus'),
    url(r'^team/xtornasol512/$', 'redi_jesus'),
    url(r'^team/cxuko/$', 'redi_jesus'),
    url(r'^team/cxu/$', 'redi_jesus'),
    url(r'^team/chuchin/$', 'redi_jesus'),
    url(r'^team/garzon/$', 'redi_jesus'),
    url(r'^team/xtornasol/$', 'redi_jesus'),
    url(r'^team/yisus/$', 'redi_jesus'),
